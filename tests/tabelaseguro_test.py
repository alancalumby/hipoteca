...
class TestTabelaSeguro(unittest.TestCase):
    ...
    def test_calcular_percentual_entrada(self):
        tabelaSeguro = tabelaseguro.TabelaSeguro(10,15,20,100,4.0,3.1,2.8,0)
        self.assertEqual(tabelaSeguro.calcular_percentual_seguro(5.0), 4.0)
        self.assertEqual(tabelaSeguro.calcular_percentual_seguro(10.0), 3.1)
        self.assertEqual(tabelaSeguro.calcular_percentual_seguro(15.0), 2.8)
        self.assertEqual(tabelaSeguro.calcular_percentual_seguro(20.0), 0)
        self.assertEqual(tabelaSeguro.calcular_percentual_seguro(25.0), 0)