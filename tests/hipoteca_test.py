...
class TestHipoteca(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.valor_entrada_04   = 600000
        self.valor_entrada_05   = 60000
        self.valor_entrada_06   = 600
        ...
        self.valor_seguro_1 = self.aliquota_nivel_4 / 100 * self.valor_casa
        self.valor_seguro_2 = self.aliquota_nivel_2 / 100 * self.valor_casa
        self.valor_seguro_3 = self.aliquota_nivel_1 / 100 * self.valor_casa
        self.valor_seguro_4 = self.aliquota_nivel_3 / 100 * self.valor_casa
        self.valor_imposto_tvq_1 = (self.valor_casa * self.aliquota_nivel_4 / 100) * self.tvq_valida / 100
        self.valor_imposto_tvq_2 = (self.valor_casa * self.aliquota_nivel_2 / 100) * self.tvq_valida / 100
        self.valor_imposto_tvq_3 = (self.valor_casa * self.aliquota_nivel_1 / 100) * self.tvq_valida / 100
        self.valor_imposto_tvq_4 = (self.valor_casa * self.aliquota_nivel_3 / 100) * self.tvq_valida / 100
        ...
        self.hipoteca_valida_04 = hipoteca.Hipoteca(self.valor_casa, self.valor_entrada_05, self.tabelaSeguro, self.tvq_valida)        
    ...
    def test_validar_config_01(self):
        with self.assertRaises(ValueError):
            # entrada menor que 5%
            self.hipoteca_invalida_01 = hipoteca.Hipoteca(self.valor_casa, self.valor_entrada_06, self.tabelaSeguro, self.tvq_valida)
    
    def test_validar_config_02(self):
        with self.assertRaises(ValueError):
            #entrada maior que valor da casa
            self.hipoteca_invalida_01 = hipoteca.Hipoteca(self.valor_casa, self.valor_entrada_04, self.tabelaSeguro, self.tvq_valida)
    
    def test_validar_config_03(self):
        with self.assertRaises(ValueError):
            #tvq maior que 100
            self.hipoteca_invalida_01 = hipoteca.Hipoteca(self.valor_casa, self.valor_entrada_05, self.tabelaSeguro, self.tvq_invalida_01)

    def test_validar_config_04(self):
        with self.assertRaises(ValueError):
            #tvq menor do que zero
            self.hipoteca_invalida_01 = hipoteca.Hipoteca(self.valor_casa, self.valor_entrada_05, self.tabelaSeguro, self.tvq_invalida_02)
    ...
    def test_calcular_valor_financiado(self):
        self.assertEqual(self.hipoteca_valida_01.calcular_valor_financiado(), (self.valor_casa - self.valor_entrada_01) + (self.valor_seguro_1) + (self.valor_imposto_tvq_1))
        self.assertEqual(self.hipoteca_valida_02.calcular_valor_financiado(), (self.valor_casa - self.valor_entrada_02) + (self.valor_seguro_2) + (self.valor_imposto_tvq_2))
        self.assertEqual(self.hipoteca_valida_03.calcular_valor_financiado(), (self.valor_casa - self.valor_entrada_03) + (self.valor_seguro_3) + (self.valor_imposto_tvq_3))
        self.assertEqual(self.hipoteca_valida_04.calcular_valor_financiado(), (self.valor_casa - self.valor_entrada_05) + (self.valor_seguro_4) + (self.valor_imposto_tvq_4))
