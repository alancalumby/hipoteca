...
hipoteca = hipoteca.Hipoteca(cfg.valor_casa, cfg.valor_entrada, tabelaSeguro)
...
print('Percentual do seguro: ' + str(tabelaSeguro.calcular_percentual_seguro(hipoteca.percentual_entrada())))